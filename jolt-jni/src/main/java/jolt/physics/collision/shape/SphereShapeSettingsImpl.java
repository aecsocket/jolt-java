...
final class SphereShapeSettingsImpl extends ConvexShapeSettingsImpl implements SphereShapeSettings {
    SphereShapeSettingsImpl(long address) { super(address); }

    @Override protected void deleteInternal() { _delete(address); }
    @JniBindDelete private static native void _delete(long _a);

    SphereShapeSettingsImpl(float radius, @Nullable PhysicsMaterial material) {
