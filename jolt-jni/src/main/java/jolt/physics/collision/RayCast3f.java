...
@JniReferenced
public final class RayCast3f {
    public JtVec3f origin = new JtVec3f();
    public JtVec3f direction = new JtVec3f();

    public RayCast3f() {}
    public RayCast3f(JtVec3f origin, JtVec3f direction) { set(origin, direction); }
    ...
    public void set(JtVec3f origin, JtVec3f direction) {
        this.origin.set(origin);
        this.direction.set(direction);
    }

    public void set(RayCast3f r) {
        set(r.origin, r.direction);
    }

    @Override
    public String toString() { return String.format("RayCast3f(%s, %s)", origin, direction); }
}
