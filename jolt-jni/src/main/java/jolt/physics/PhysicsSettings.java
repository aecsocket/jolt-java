...
@JniHeader("""
        void ToJava(JNIEnv* env, const PhysicsSettings from, jobject to) {
            JNI_PhysicsSettings_set(env, to,
                from.maxInFlightBodyPairs,
                from.stepListenersBatchSize,
                from.stepListenerBatchesPerJob,
                from.baumgarte,
                from.speculativeContactDistance,
                from.penetrationSlop,
                from.linearCastThreshold,
                from.linearCastMaxPenetration,
                from.manifoldToleranceSq,
                from.maxPenetrationDistance,
                from.bodyPairCacheMaxDeltaPositionSq,
                from.bodyPairCacheCosMaxDeltaRotationDiv2,
                from.contactNormalCosMaxDeltaRotation,
                from.contactPointPreserveLambdaMaxDistSq,
                from.numVelocitySteps,
                from.numPositionSteps,
                from.minVelocityForRestitution,
                from.timeBeforeSleep,
                from.pointVelocitySleepThreshold,
                from.constraintWarmStart,
                from.useBodyPairContactCache,
                from.useManifoldReduction,
                from.allowSleeping,
                from.checkActiveEdges);
        }""")
