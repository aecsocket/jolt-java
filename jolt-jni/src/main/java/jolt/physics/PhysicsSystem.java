...
public final class PhysicsSystem extends JoltNativeImpl {
    ...
    public PhysicsSettings getPhysicsSettings() { return getPhysicsSettings(new PhysicsSettings()); }
    ...
    public void addConstraints(Collection<Constraint> constraints) { addConstraints(constraints.toArray(new Constraint[0])); }
    @JniBindSelf("""
    ...
    public void removeConstraints(Collection<Constraint> constraints) { removeConstraints(constraints.toArray(new Constraint[0])); }
