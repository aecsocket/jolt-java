# JoltJava: from https://raw.githubusercontent.com/jrouwe/JoltPhysics/master/Jolt/Jolt.cmake
# Requires C++ 17
...
#	${JOLT_PHYSICS_ROOT}/Physics/Collision/EstimateCollisionResponse.cpp # JoltJava
#	${JOLT_PHYSICS_ROOT}/Physics/Collision/EstimateCollisionResponse.h # JoltJava
...
#	${JOLT_PHYSICS_ROOT}/Physics/Collision/Shape/TaperedCapsuleShape.gliffy # JoltJava
...
target_compile_definitions(Jolt PUBLIC "$<$<CONFIG:Debug>:_DEBUG;JPH_DEBUG_RENDERER>") # JoltJava: undef JPH_PROFILE_ENABLED since JoltPhysicsC doesn't support it
target_compile_definitions(Jolt PUBLIC "$<$<CONFIG:Release>:NDEBUG;JPH_DEBUG_RENDERER>") # JoltJava: undef JPH_PROFILE_ENABLED since JoltPhysicsC doesn't support it
target_compile_definitions(Jolt PUBLIC "$<$<CONFIG:Distribution>:NDEBUG>")
target_compile_definitions(Jolt PUBLIC "$<$<CONFIG:ReleaseASAN>:NDEBUG;JPH_DISABLE_TEMP_ALLOCATOR;JPH_DISABLE_CUSTOM_ALLOCATOR;JPH_DEBUG_RENDERER>") # JoltJava: undef JPH_PROFILE_ENABLED since JoltPhysicsC doesn't support it
target_compile_definitions(Jolt PUBLIC "$<$<CONFIG:ReleaseUBSAN>:NDEBUG;JPH_DEBUG_RENDERER>") # JoltJava: undef JPH_PROFILE_ENABLED since JoltPhysicsC doesn't support it
