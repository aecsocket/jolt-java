...
public final class CollideShapeCollector extends CollisionCollector {
    ...
    public static CollideShapeCollector collectingInto(MemorySession session, Collection<? super CollideShapeResult> out) {
        return CollideShapeCollector.of(session, out::add);
    }
