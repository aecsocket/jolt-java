...
public class JPJ_BroadPhaseLayerFilter {
    ...
    public static MemoryAddress vtable$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPJ_BroadPhaseLayerFilter.vtable$VH.get(seg);
    }
    ...
    public static MemoryAddress vtable$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPJ_BroadPhaseLayerFilter.vtable$VH.get(seg.asSlice(index*sizeof()));
    }
