...
public interface JPC_AlignedAllocateFunction {
    ...
    static MemorySegment allocate(JPC_AlignedAllocateFunction fi, MemorySession session) {
        return RuntimeHelper.upcallStub(JPC_AlignedAllocateFunction.class, fi, constants$18.JPC_AlignedAllocateFunction$FUNC, session);
    }
    static JPC_AlignedAllocateFunction ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (long _in_size, long _in_alignment) -> {
            try {
                return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)constants$18.JPC_AlignedAllocateFunction$MH.invokeExact((Addressable)symbol, _in_size, _in_alignment);
            } catch (Throwable ex$) {
