...
public class JPC_CollideShapeBodyCollector {
    ...
    public static VarHandle early_out_fraction$VH() {
        return JPC_CollideShapeBodyCollector.early_out_fraction$VH;
    }
    public static float early_out_fraction$get(MemorySegment seg) {
        return (float)JPC_CollideShapeBodyCollector.early_out_fraction$VH.get(seg);
    }
    public static void early_out_fraction$set( MemorySegment seg, float x) {
        JPC_CollideShapeBodyCollector.early_out_fraction$VH.set(seg, x);
    }
    public static float early_out_fraction$get(MemorySegment seg, long index) {
        return (float)JPC_CollideShapeBodyCollector.early_out_fraction$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void early_out_fraction$set(MemorySegment seg, long index, float x) {
        JPC_CollideShapeBodyCollector.early_out_fraction$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle context$VH() {
        return JPC_CollideShapeBodyCollector.context$VH;
    }
    public static MemoryAddress context$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPC_CollideShapeBodyCollector.context$VH.get(seg);
    }
    public static void context$set( MemorySegment seg, MemoryAddress x) {
        JPC_CollideShapeBodyCollector.context$VH.set(seg, x);
    }
    public static MemoryAddress context$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPC_CollideShapeBodyCollector.context$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void context$set(MemorySegment seg, long index, MemoryAddress x) {
        JPC_CollideShapeBodyCollector.context$VH.set(seg.asSlice(index*sizeof()), x);
    }
