...
public class JPC_CastShapeCollectorVTable {
    ...
    ).withName("JPC_CastShapeCollectorVTable");
    public static MemoryLayout $LAYOUT() {
        return JPC_CastShapeCollectorVTable.$struct$LAYOUT;
    }
    ...
    public static VarHandle __unused0$VH() {
        return JPC_CastShapeCollectorVTable.__unused0$VH;
    }
    public static MemoryAddress __unused0$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPC_CastShapeCollectorVTable.__unused0$VH.get(seg);
    }
    public static void __unused0$set( MemorySegment seg, MemoryAddress x) {
        JPC_CastShapeCollectorVTable.__unused0$VH.set(seg, x);
    }
    public static MemoryAddress __unused0$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPC_CastShapeCollectorVTable.__unused0$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __unused0$set(MemorySegment seg, long index, MemoryAddress x) {
        JPC_CastShapeCollectorVTable.__unused0$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle __unused1$VH() {
        return JPC_CastShapeCollectorVTable.__unused1$VH;
    }
    public static MemoryAddress __unused1$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPC_CastShapeCollectorVTable.__unused1$VH.get(seg);
    }
    public static void __unused1$set( MemorySegment seg, MemoryAddress x) {
        JPC_CastShapeCollectorVTable.__unused1$VH.set(seg, x);
    }
    public static MemoryAddress __unused1$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPC_CastShapeCollectorVTable.__unused1$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __unused1$set(MemorySegment seg, long index, MemoryAddress x) {
        JPC_CastShapeCollectorVTable.__unused1$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    static final MethodHandle Reset$MH = RuntimeHelper.downcallHandle(
        JPC_CastShapeCollectorVTable.Reset$FUNC
    );
    public interface Reset {

        void apply(java.lang.foreign.MemoryAddress _x0);
        static MemorySegment allocate(Reset fi, MemorySession session) {
            return RuntimeHelper.upcallStub(Reset.class, fi, JPC_CastShapeCollectorVTable.Reset$FUNC, session);
        }
        static Reset ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0) -> {
                try {
                    JPC_CastShapeCollectorVTable.Reset$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    public static VarHandle Reset$VH() {
        return JPC_CastShapeCollectorVTable.Reset$VH;
    }
    public static MemoryAddress Reset$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPC_CastShapeCollectorVTable.Reset$VH.get(seg);
    }
    public static void Reset$set( MemorySegment seg, MemoryAddress x) {
        JPC_CastShapeCollectorVTable.Reset$VH.set(seg, x);
    }
    public static MemoryAddress Reset$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPC_CastShapeCollectorVTable.Reset$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void Reset$set(MemorySegment seg, long index, MemoryAddress x) {
        JPC_CastShapeCollectorVTable.Reset$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle OnBody$VH() {
        return JPC_CastShapeCollectorVTable.OnBody$VH;
    }
    public static MemoryAddress OnBody$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPC_CastShapeCollectorVTable.OnBody$VH.get(seg);
    }
    public static void OnBody$set( MemorySegment seg, MemoryAddress x) {
        JPC_CastShapeCollectorVTable.OnBody$VH.set(seg, x);
    }
    public static MemoryAddress OnBody$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPC_CastShapeCollectorVTable.OnBody$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void OnBody$set(MemorySegment seg, long index, MemoryAddress x) {
        JPC_CastShapeCollectorVTable.OnBody$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle AddHit$VH() {
        return JPC_CastShapeCollectorVTable.AddHit$VH;
    }
    public static MemoryAddress AddHit$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPC_CastShapeCollectorVTable.AddHit$VH.get(seg);
    }
    public static void AddHit$set( MemorySegment seg, MemoryAddress x) {
        JPC_CastShapeCollectorVTable.AddHit$VH.set(seg, x);
    }
    public static MemoryAddress AddHit$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPC_CastShapeCollectorVTable.AddHit$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void AddHit$set(MemorySegment seg, long index, MemoryAddress x) {
        JPC_CastShapeCollectorVTable.AddHit$VH.set(seg.asSlice(index*sizeof()), x);
    }
