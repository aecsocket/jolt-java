...
public class JPC_ObjectLayerFilterVTable {
    ...
    public static MemoryAddress __unused0$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPC_ObjectLayerFilterVTable.__unused0$VH.get(seg);
    }
    ...
    public static MemoryAddress __unused0$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPC_ObjectLayerFilterVTable.__unused0$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress __unused1$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPC_ObjectLayerFilterVTable.__unused1$VH.get(seg);
    }
    ...
    public static MemoryAddress __unused1$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPC_ObjectLayerFilterVTable.__unused1$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public interface ShouldCollide {
        ...
        boolean apply(java.lang.foreign.MemoryAddress _x0, short _x1);
        ...
        static ShouldCollide ofAddress(MemoryAddress addr, MemorySession session) {
            ...
            return (java.lang.foreign.MemoryAddress __x0, short __x1) -> {
                try {
                    return (boolean)JPC_ObjectLayerFilterVTable.ShouldCollide$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress ShouldCollide$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPC_ObjectLayerFilterVTable.ShouldCollide$VH.get(seg);
    }
    ...
    public static MemoryAddress ShouldCollide$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPC_ObjectLayerFilterVTable.ShouldCollide$VH.get(seg.asSlice(index*sizeof()));
    }
