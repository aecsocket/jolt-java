...
public class JPC_ContactListener {

    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        Constants$root.C_POINTER$LAYOUT.withName("vtable")
    ).withName("JPC_ContactListener");
    public static MemoryLayout $LAYOUT() {
        return JPC_ContactListener.$struct$LAYOUT;
    }
    ...
    public static VarHandle vtable$VH() {
        return JPC_ContactListener.vtable$VH;
    }
    public static MemoryAddress vtable$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPC_ContactListener.vtable$VH.get(seg);
    }
    public static void vtable$set( MemorySegment seg, MemoryAddress x) {
        JPC_ContactListener.vtable$VH.set(seg, x);
    }
    public static MemoryAddress vtable$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPC_ContactListener.vtable$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void vtable$set(MemorySegment seg, long index, MemoryAddress x) {
        JPC_ContactListener.vtable$VH.set(seg.asSlice(index*sizeof()), x);
    }
