...
public class JPJ_CastShapeBodyCollector {
    ...
    ).withName("JPJ_CastShapeBodyCollector");
    public static MemoryLayout $LAYOUT() {
        return JPJ_CastShapeBodyCollector.$struct$LAYOUT;
    }
    ...
    public static VarHandle vtable$VH() {
        return JPJ_CastShapeBodyCollector.vtable$VH;
    }
    public static MemoryAddress vtable$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPJ_CastShapeBodyCollector.vtable$VH.get(seg);
    }
    public static void vtable$set( MemorySegment seg, MemoryAddress x) {
        JPJ_CastShapeBodyCollector.vtable$VH.set(seg, x);
    }
    public static MemoryAddress vtable$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPJ_CastShapeBodyCollector.vtable$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void vtable$set(MemorySegment seg, long index, MemoryAddress x) {
        JPJ_CastShapeBodyCollector.vtable$VH.set(seg.asSlice(index*sizeof()), x);
    }
