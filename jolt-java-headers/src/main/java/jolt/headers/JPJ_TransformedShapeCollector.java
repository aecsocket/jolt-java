...
public class JPJ_TransformedShapeCollector {
    ...
    ).withName("JPJ_TransformedShapeCollector");
    public static MemoryLayout $LAYOUT() {
        return JPJ_TransformedShapeCollector.$struct$LAYOUT;
    }
    ...
    public static VarHandle vtable$VH() {
        return JPJ_TransformedShapeCollector.vtable$VH;
    }
    public static MemoryAddress vtable$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPJ_TransformedShapeCollector.vtable$VH.get(seg);
    }
    public static void vtable$set( MemorySegment seg, MemoryAddress x) {
        JPJ_TransformedShapeCollector.vtable$VH.set(seg, x);
    }
    public static MemoryAddress vtable$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPJ_TransformedShapeCollector.vtable$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void vtable$set(MemorySegment seg, long index, MemoryAddress x) {
        JPJ_TransformedShapeCollector.vtable$VH.set(seg.asSlice(index*sizeof()), x);
    }
