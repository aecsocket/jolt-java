...
public class JPC_BodyLockWrite {
    ...
    public static MemoryAddress lock_interface$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPC_BodyLockWrite.lock_interface$VH.get(seg);
    }
    ...
    public static MemoryAddress lock_interface$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPC_BodyLockWrite.lock_interface$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress mutex$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPC_BodyLockWrite.mutex$VH.get(seg);
    }
    ...
    public static MemoryAddress mutex$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPC_BodyLockWrite.mutex$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress body$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPC_BodyLockWrite.body$VH.get(seg);
    }
    ...
    public static MemoryAddress body$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPC_BodyLockWrite.body$VH.get(seg.asSlice(index*sizeof()));
    }
