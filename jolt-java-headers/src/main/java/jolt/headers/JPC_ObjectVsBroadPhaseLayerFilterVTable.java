...
public class JPC_ObjectVsBroadPhaseLayerFilterVTable {
    ...
    static final MethodHandle ShouldCollide$MH = jolt.headers.RuntimeHelper.downcallHandle(
        JPC_ObjectVsBroadPhaseLayerFilterVTable.ShouldCollide$FUNC
    );
    public interface ShouldCollide {
        ...
        static MemorySegment allocate(ShouldCollide fi, MemorySession session) {
            return jolt.headers.RuntimeHelper.upcallStub(ShouldCollide.class, fi, JPC_ObjectVsBroadPhaseLayerFilterVTable.ShouldCollide$FUNC, session);
        }
