...
public class JPC_ObjectLayerPairFilterVTable {
    ...
    public static MemoryAddress __unused0$get(MemorySegment seg) {
        return (MemoryAddress)JPC_ObjectLayerPairFilterVTable.__unused0$VH.get(seg);
    }
    ...
    public static MemoryAddress __unused0$get(MemorySegment seg, long index) {
        return (MemoryAddress)JPC_ObjectLayerPairFilterVTable.__unused0$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress __unused1$get(MemorySegment seg) {
        return (MemoryAddress)JPC_ObjectLayerPairFilterVTable.__unused1$VH.get(seg);
    }
    ...
    public static MemoryAddress __unused1$get(MemorySegment seg, long index) {
        return (MemoryAddress)JPC_ObjectLayerPairFilterVTable.__unused1$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public interface ShouldCollide {
        ...
        static ShouldCollide ofAddress(MemoryAddress addr, MemorySession session) {
            ...
            return (MemoryAddress __x0, short __x1, short __x2) -> {
                try {
                    return (boolean)JPC_ObjectLayerPairFilterVTable.ShouldCollide$MH.invokeExact((Addressable)symbol, (Addressable)__x0, __x1, __x2);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress ShouldCollide$get(MemorySegment seg) {
        return (MemoryAddress)JPC_ObjectLayerPairFilterVTable.ShouldCollide$VH.get(seg);
    }
    ...
    public static MemoryAddress ShouldCollide$get(MemorySegment seg, long index) {
        return (MemoryAddress)JPC_ObjectLayerPairFilterVTable.ShouldCollide$VH.get(seg.asSlice(index*sizeof()));
    }
