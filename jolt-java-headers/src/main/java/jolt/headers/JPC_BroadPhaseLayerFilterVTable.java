...
public class JPC_BroadPhaseLayerFilterVTable {
    ...
    public static MemoryAddress __unused0$get(MemorySegment seg) {
        return (MemoryAddress)JPC_BroadPhaseLayerFilterVTable.__unused0$VH.get(seg);
    }
    ...
    public static MemoryAddress __unused0$get(MemorySegment seg, long index) {
        return (MemoryAddress)JPC_BroadPhaseLayerFilterVTable.__unused0$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress __unused1$get(MemorySegment seg) {
        return (MemoryAddress)JPC_BroadPhaseLayerFilterVTable.__unused1$VH.get(seg);
    }
    ...
    public static MemoryAddress __unused1$get(MemorySegment seg, long index) {
        return (MemoryAddress)JPC_BroadPhaseLayerFilterVTable.__unused1$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public interface ShouldCollide {
        ...
        static ShouldCollide ofAddress(MemoryAddress addr, MemorySession session) {
            ...
            return (MemoryAddress __x0, byte __x1) -> {
                try {
                    return (boolean)JPC_BroadPhaseLayerFilterVTable.ShouldCollide$MH.invokeExact((Addressable)symbol, (Addressable)__x0, __x1);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress ShouldCollide$get(MemorySegment seg) {
        return (MemoryAddress)JPC_BroadPhaseLayerFilterVTable.ShouldCollide$VH.get(seg);
    }
    ...
    public static MemoryAddress ShouldCollide$get(MemorySegment seg, long index) {
        return (MemoryAddress)JPC_BroadPhaseLayerFilterVTable.ShouldCollide$VH.get(seg.asSlice(index*sizeof()));
    }
