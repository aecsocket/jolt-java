...
public class JPJ_BodyActivationListener {
    ...
    public static MemoryAddress vtable$get(MemorySegment seg) {
        return (MemoryAddress)JPJ_BodyActivationListener.vtable$VH.get(seg);
    }
    ...
    public static MemoryAddress vtable$get(MemorySegment seg, long index) {
        return (MemoryAddress)JPJ_BodyActivationListener.vtable$VH.get(seg.asSlice(index*sizeof()));
    }
