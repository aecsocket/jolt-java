...
public class JPJ_BodyFilter {
    ...
    public static MemoryAddress vtable$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)JPJ_BodyFilter.vtable$VH.get(seg);
    }
    ...
    public static MemoryAddress vtable$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)JPJ_BodyFilter.vtable$VH.get(seg.asSlice(index*sizeof()));
    }
